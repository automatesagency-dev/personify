        ...
        <div className="mt-3 p-4 bg-black/40 rounded-lg border border-gray-700">
          <div className="flex items-center gap-4">
            <input
              ...
              className="h-12 w-24 rounded cursor-pointer border-2 border-gray-600"
            />
            <div className="flex-1">
              <input
                ...
                onChange={(e) => onChange(e.target.value)}
                placeholder="#000000"
                className="w-full px-3 py-2 bg-black/40 border border-gray-600 rounded text-white text-sm font-mono"
              />
            </div>
          </div>
        </div>
