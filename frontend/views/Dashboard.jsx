          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-6 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <Link href="/persona" className="inline-block px-6 py-2 bg-yellow-500 text-black rounded-lg hover:bg-yellow-400 transition font-medium">Create Persona →</Link>
              </div>
            </div>
          </div>
        )}
